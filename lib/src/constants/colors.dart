...
const Color COLOR_SECONDARY = Color.fromARGB(255, 243, 159, 90);
const Color COLOR_TERTIARY = Color.fromARGB(255, 255, 235, 206);
const Color COLOR_ON_BOARDING_THIRD = Color.fromARGB(255, 245, 213, 164);
const Color COLOR_TEXT_BORDER = Color.fromARGB(255, 110, 110, 110);
const Color COLOR_TEXT_PRIMARY = Color.fromARGB(255, 44, 51, 51);
